...
function handleQuadTreeClick(imageData, context){
    return (e) => {
        ...
        //make new canvas to get rid of event handlers
         ...
         Object(__WEBPACK_IMPORTED_MODULE_0__quadtree_js__["a" /* default */])(imageData, context, blockSize, circleBool, traverseType);
    };
}
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = QuadtreeMaker;
